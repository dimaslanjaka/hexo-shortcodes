...
const production = {
  'binary-collections': 'https://github.com/dimaslanjaka/bin/raw/master/releases/bin.tgz',
  ...
  'nodejs-package-types':
    'https://github.com/dimaslanjaka/nodejs-package-types/raw/main/release/nodejs-package-types.tgz',
  ...
  'hexo-generator-redirect':
    'https://github.com/dimaslanjaka/hexo-generator-redirect/raw/master/release/hexo-generator-redirect.tgz'
};
